...
export const getLocationLatLongList = async () => {
    try {
        const response = await fetch(`https://eco-vista-786.netlify.app/api/location`);
        const data = await response.json();
        return data;
    } catch (e) {
        console.error(e.message);
...
export const getLocationLatLong = async (locationName) => {
    try {
        const response = await fetch(`https://eco-vista-786.netlify.app/api/location/${locationName}`);
        const data = await response.json();
        return data;
    } catch (e) {
        console.error(e.message);
